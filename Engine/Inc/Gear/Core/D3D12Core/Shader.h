...
#ifndef _CORE_D3D12CORE_SHADER_H_
#define _CORE_D3D12CORE_SHADER_H_
...
namespace Core
{
	namespace D3D12Core
	{
		...
		public:
			...
			Shader(const std::wstring& filePath, const Core::D3D12Core::DXCCompiler::ShaderProfile profile);
...
#endif // !_CORE_D3D12CORE_SHADER_H_