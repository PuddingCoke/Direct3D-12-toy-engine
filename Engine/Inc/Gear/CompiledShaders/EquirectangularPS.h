...
;
; shader hash: b74842a3d68b85c0a5f754385c64fc0b
;
...
define void @main() {
  ...
  %11 = call float @dx.op.dot3.f32(i32 55, float %4, float %5, float %6, float %4, float %5, float %6)  ; Dot3(ax,ay,az,bx,by,bz)
  %12 = call float @dx.op.unary.f32(i32 25, float %11)  ; Rsqrt(value)
  %13 = fmul fast float %12, %4
  %14 = fmul fast float %12, %6
  %15 = fdiv fast float %13, %14
  %16 = call float @dx.op.unary.f32(i32 17, float %15)  ; Atan(value)
  %17 = fadd fast float %16, 0x400921FB60000000
  %18 = fadd fast float %16, 0xC00921FB60000000
  %19 = fcmp fast olt float %14, 0.000000e+00
  %20 = fcmp fast oeq float %14, 0.000000e+00
  %21 = fcmp fast oge float %13, 0.000000e+00
  %22 = fcmp fast olt float %13, 0.000000e+00
  %23 = and i1 %19, %21
  %24 = select i1 %23, float %17, float %16
  %25 = and i1 %19, %22
  %26 = select i1 %25, float %18, float %24
  %27 = and i1 %20, %22
  %28 = and i1 %20, %21
  %29 = fmul fast float %5, %12
  %30 = fsub fast float -0.000000e+00, %29
  %31 = call float @dx.op.unary.f32(i32 16, float %30)  ; Asin(value)
  %32 = fmul fast float %26, 0x3FC45D6380000000
  %33 = fmul fast float %31, 0x3FD45F0700000000
  %34 = fadd fast float %32, 5.000000e-01
  %35 = select i1 %27, float 0x3FD0016A00000000, float %34
  %36 = select i1 %28, float 0x3FE7FF4B00000000, float %35
  %37 = fadd fast float %33, 5.000000e-01
  %38 = call %dx.types.Handle @dx.op.annotateHandle(i32 216, %dx.types.Handle %1, %dx.types.ResourceProperties { i32 14, i32 0 })  ; AnnotateHandle(res,props)  resource: SamplerState
  %39 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %10, %dx.types.Handle %38, float %36, float %37, float undef, float undef, i32 0, i32 0, i32 undef, float undef)  ; Sample(srv,sampler,coord0,coord1,coord2,coord3,offset0,offset1,offset2,clamp)
...
!3 = !{null, null, !4, !6}
!4 = !{!5}
!5 = !{i32 0, %TextureIndex* undef, !"", i32 0, i32 2, i32 1, i32 4, null}
!6 = !{!7}
...
!10 = !{!11, !15, null}
!11 = !{!12}
!12 = !{i32 0, !"POSITION", i8 9, i8 0, !13, i8 2, i32 1, i8 3, i32 0, i8 0, !14}
!13 = !{i32 0}
!14 = !{i32 3, i32 7}
!15 = !{!16}
...
const unsigned char g_EquirectangularPSBytes[] = {
  0x44, 0x58, 0x42, 0x43, 0xea, 0xf2, 0x8a, 0xbb, 0xb0, 0x41, 0x76, 0x48,
  0xa1, 0x10, 0x7b, 0x65, 0x96, 0x32, 0xd0, 0x36, 0x01, 0x00, 0x00, 0x00,
  0x47, 0x11, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00,
  0x4c, 0x00, 0x00, 0x00, 0x85, 0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x00,
  0x7f, 0x01, 0x00, 0x00, 0xb7, 0x08, 0x00, 0x00, 0xd3, 0x08, 0x00, 0x00,
  ...
  0x50, 0x4f, 0x53, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0