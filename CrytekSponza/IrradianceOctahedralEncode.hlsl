...
static const float3 randomDirection[SAMPLECOUNT] =
{
    ...
    float3(-0.710939, 0.693258, 0.11846),
    float3(-0.716907, -0.657643, 0.23408),
    float3(-0.197943, -0.979167, 0.0452791),
    float3(0.548249, -0.833655, 0.0666598),
    float3(0.838604, -0.544, 0.179265),
    ...
    float3(-0.132939, -0.98394, -0.119336),
    float3(0.511186, -0.842927, -0.16782),
    float3(0.94608, -0.388928, -0.110575),
    float3(0.924571, 0.45544, -0.352115),
    ...
    float3(-0.100279, -0.74356, -0.69256),
...
void main(uint2 DTid : SV_DispatchThreadID)
{
    ...
    if (!isBorderTexel)
    {
        ...
        result += envCube.SampleLevel(linearClampSampler, dir, 0.0).rgb;
        ...
        result = 1.0989 * PI * result / (float(SAMPLECOUNT));
